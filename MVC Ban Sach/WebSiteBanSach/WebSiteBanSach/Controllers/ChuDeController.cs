...
namespace WebSiteBanSach.Controllers
{
    public class ChuDeController : Controller
    {
        ...
        { 
            ...
            ViewBag.lstChuDe = db.ChuDe.ToList();
            return View(lstSach);
        }
        ...
        public ViewResult DanhMucChuDe()
        {
            ...
            int MaChuDe = int.Parse(db.ChuDe.ToList().ElementAt(0).MaChuDe.ToString());
            //Tạo 1 viewbag gán sách theo chủ đề đầu tiên trong csdl
            ViewBag.SachTheoChuDe = db.Sach.Where(n => n.MaChuDe == MaChuDe).ToList() ;
