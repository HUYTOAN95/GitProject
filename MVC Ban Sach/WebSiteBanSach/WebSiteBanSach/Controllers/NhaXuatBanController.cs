...
namespace WebSiteBanSach.Controllers
{
    public class NhaXuatBanController : Controller
    {
        ...
        {
            return PartialView(db.NhaXuatBan.Take(10).OrderBy(x=>x.TenNXB).ToList());
        }
        ...
        public ViewResult SachTheoNXB(int MaNXB=0)
        {
            ...
            ViewBag.lstNXB = db.NhaXuatBan.ToList();
            return View(lstSach);
        }
        ...
        public ViewResult DanhMucNXB()
        {
            ...
            int MaNXB = int.Parse(db.NhaXuatBan.ToList().ElementAt(0).MaNXB.ToString());
            //Tạo 1 viewbag gán sách theo Nhà xuất bản đầu tiên trong csdl
            ViewBag.SachTheoNXB = db.Sach.Where(n => n.MaNXB == MaNXB).ToList();
